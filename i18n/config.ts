...
const enTranslations = {
    ...
    "admin": {
        ...
        "bulkUploadDealers": "Bulk upload dealers",
        "addNewModel": "Add New Model",
        "bulkUploadModels": "Bulk upload models",
        ...
        "edit": "Edit",
        "logout": "Logout",
        "pendingDealers": "Pending Dealers",
        "approvedDealers": "Approved Dealers",
        "noPendingDealers": "No dealers awaiting approval.",
        "noApprovedDealers": "No approved dealers yet.",
        ...
        "bulkUploadPosts": "Bulk upload blog posts",
        "editBlogPost": "Edit Blog Post",
        "bulkImport": {
            "missingMapping": "Please map all required columns before importing.",
            "noValidRows": "No valid rows to import.",
            "starting": "Starting import of {{count}} {{entity}}",
            "rowFailed": "Row {{index}} failed: {{message}}",
            "success": "Successfully imported {{count}} {{entity}}.",
            "partial": "Imported {{success}} {{entity}} with {{failed}} failures.",
            "failed": "Import failed. Please review the errors and try again.",
            "templateTitle": "Template headers",
            "templateDescription": "Prepare a spreadsheet with the following column headers before uploading.",
            "instructions": "Formatting tips",
            ...
            "previewSummary": "{{valid}} valid rows · {{invalid}} rows with issues",
            "processing": "Processing {{processed}} / {{total}}",
            "invalidRows": "Rows with validation errors (skipped automatically)",
            "rowNumber": "Row {{row}}",
            "additionalRows": "+{{count}} more rows with issues",
            "rowHeader": "Row",
            "summary": "Imported {{success}} / {{total}} rows ({{failed}} failed, {{skipped}} skipped).",
            "importCta": "Import {{count}} rows"
        },
        "loading": "Loading admin data…",
        "errorTitle": "We couldn't load admin data.",
        "tryAgain": "Try again"
    },
    "compare": {
...
const sqTranslations = {
    ...
    "admin": {
        ...
        "bulkUploadDealers": "Ngarkim masiv i shitësve",
        "addNewModel": "Shto Model të Ri",
        "bulkUploadModels": "Ngarkim masiv i modeleve",
        ...
        "edit": "Modifiko",
        "logout": "Dil",
        "pendingDealers": "Shitësit në pritje",
        "approvedDealers": "Shitësit e aprovuar",
        "noPendingDealers": "Nuk ka shitës në pritje të aprovimit.",
        "noApprovedDealers": "Nuk ka ende shitës të aprovuar.",
        ...
        "noBlogPosts": "Nuk ka ende postime në blog.",
        "dateUnknown": "Data e panjohur",
        "addBlogPost": "Shto postim blogu",
        "bulkUploadPosts": "Ngarkim masiv i postimeve të blogut",
        "editBlogPost": "Përditëso postimin",
        "bulkImport": {
            "missingMapping": "Ju lutemi lidhni të gjitha kolonat e detyrueshme para importit.",
            "noValidRows": "Nuk ka rreshta të vlefshëm për t'u importuar.",
            "starting": "Duke filluar importin e {{count}} {{entity}}",
            "rowFailed": "Rreshti {{index}} dështoi: {{message}}",
            "success": "U importuan me sukses {{count}} {{entity}}.",
            "partial": "U importuan {{success}} {{entity}} me {{failed}} dështime.",
            "failed": "Importi dështoi. Ju lutemi rishikoni gabimet dhe provoni përsëri.",
            "templateTitle": "Kokat e kolonave",
            "templateDescription": "Përgatitni një tabelë me kolonat e mëposhtme para ngarkimit.",
            "instructions": "Këshilla formatimi",
            "selectFile": "Zgjidhni skedar CSV ose Excel",
            "selectedFile": "Skedari i ngarkuar",
            "mappingTitle": "Lidh kolonat me fushat",
            "reset": "Rivendos",
            "skipColumn": "Kalo kolonën",
            "previewTitle": "Parapamje e verifikimit",
            "previewSummary": "{{valid}} rreshta të vlefshëm · {{invalid}} rreshta me probleme",
            "processing": "Duke përpunuar {{processed}} / {{total}}",
            "invalidRows": "Rreshta me gabime validimi (kalohen automatikisht)",
            "rowNumber": "Rreshti {{row}}",
            "additionalRows": "+{{count}} rreshta të tjerë me probleme",
            "rowHeader": "Rreshti",
            "summary": "U importuan {{success}} / {{total}} rreshta ({{failed}} dështuan, {{skipped}} u kapërcyen).",
            "importCta": "Importo {{count}} rreshta"
        },
        "loading": "Duke ngarkuar të dhënat e administrimit...",
        "errorTitle": "Nuk mundëm të ngarkojmë të dhënat e administrimit.",
...
const itTranslations = {
    ...
    "admin": {
        ...
        "bulkUploadDealers": "Importazione massiva concessionari",
        "addNewModel": "Aggiungi Nuovo Modello",
        "bulkUploadModels": "Importazione massiva modelli",
        ...
        "edit": "Modifica",
        "logout": "Esci",
        "pendingDealers": "Concessionari in attesa",
        "approvedDealers": "Concessionari approvati",
        "noPendingDealers": "Nessun concessionario in attesa di approvazione.",
        "noApprovedDealers": "Nessun concessionario approvato al momento.",
        ...
        "noBlogPosts": "Nessun articolo pubblicato.",
        "dateUnknown": "Data sconosciuta",
        "addBlogPost": "Aggiungi articolo",
        "bulkUploadPosts": "Importazione massiva articoli blog",
        "editBlogPost": "Modifica articolo",
        "bulkImport": {
            "missingMapping": "Mappa tutte le colonne obbligatorie prima di importare.",
            "noValidRows": "Nessuna riga valida da importare.",
            "starting": "Avvio importazione di {{count}} {{entity}}",
            "rowFailed": "Riga {{index}} non riuscita: {{message}}",
            "success": "Importati con successo {{count}} {{entity}}.",
            "partial": "Importati {{success}} {{entity}} con {{failed}} errori.",
            "failed": "Importazione non riuscita. Controlla gli errori e riprova.",
            "templateTitle": "Intestazioni del modello",
            "templateDescription": "Prepara un foglio con le seguenti intestazioni di colonna prima di caricare.",
            "instructions": "Suggerimenti di formattazione",
            "selectFile": "Seleziona file CSV o Excel",
            "selectedFile": "File caricato",
            "mappingTitle": "Abbina colonne ai campi",
            "reset": "Reimposta",
            "skipColumn": "Salta colonna",
            "previewTitle": "Anteprima convalida",
            "previewSummary": "{{valid}} righe valide · {{invalid}} righe con problemi",
            "processing": "Elaborazione {{processed}} / {{total}}",
            "invalidRows": "Righe con errori di validazione (saltate automaticamente)",
            "rowNumber": "Riga {{row}}",
            "additionalRows": "+{{count}} altre righe con problemi",
            "rowHeader": "Riga",
            "summary": "Importate {{success}} / {{total}} righe ({{failed}} fallite, {{skipped}} saltate).",
            "importCta": "Importa {{count}} righe"
        },
        "loading": "Caricamento dati amministrazione...",
        "errorTitle": "Impossibile caricare i dati di amministrazione.",
        "tryAgain": "Riprova"
    },
    "compare": {
