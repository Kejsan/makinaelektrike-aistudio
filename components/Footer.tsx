    ...
    <footer className="bg-transparent text-white mt-16 border-t border-gray-cyan/30">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                ...
                <li><a href="/sitemap.xml" className="text-base text-gray-300 hover:text-white">{t('footer.sitemap')}</a></li>
              </ul>
            </div>
            <div>
        ...
        <div className="mt-12 border-t border-gray-500/50 pt-8">
          <div className="flex flex-col gap-4 text-base text-gray-400 md:flex-row md:items-center md:justify-between">
            <p className="text-left">&copy; {new Date().getFullYear()} Makina Elektrike. {t('footer.rightsReserved')}</p>
            <p className="text-left">
              {t('footer.madeBy')}{' '}
              <a
                href="https://kejsan-coku.netlify.app/"
                className="text-gray-200 hover:text-gray-cyan transition-colors"
                target="_blank"
